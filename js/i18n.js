...
(function (global) {
  ...
  const S = {
    en: {
      ...
      fix_upcoming: 'Live & upcoming', fix_results: 'Results', fix_earlier: 'Earlier results ({0})',
    ...
    es: {
      ...
      fix_upcoming: 'En vivo y próximos', fix_results: 'Resultados', fix_earlier: 'Resultados anteriores ({0})',
