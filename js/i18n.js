...
(function (global) {
  ...
  const S = {
    en: {
      ...
      scorer_in: 'Still in the tournament', scorer_out: 'Eliminated',
      col_player: 'Player', col_goals: 'Goals',
      col_wc_total: 'WC total',
      tip_wc_total: 'All-time World Cup goals (previous editions + this tournament)',
      group_label: 'Group',
      ...
      fix_search_ph: 'Search a country…', fix_no_results: 'No matches for that search.',
      ...
      scn_title: 'What needs to happen (final matchday)',
      scn_win: 'Win', scn_draw: 'Draw', scn_lose: 'Lose',
      scn_qualify: 'Through', scn_inplay: 'In play', scn_third: '3rd-place hopes', scn_out: 'Out', scn_through: 'Already through',
      ...
      col_chance: 'R32 %', tip_chance: 'Estimated chance to reach the Round of 32 (simulated from FIFA rankings). 100% = already locked in, 0% = out.',
      ...
      badge_clinched: '🔒 QUALIFIED', tip_clinched: 'Clinched a top-8 third place — guaranteed to advance whatever happens.',
      ...
      bracket_hint: 'Tap a team to pick who advances. Played games are filled in automatically.',
      bracket_reset: 'Reset picks', champion: 'Champion', bracket_result: 'actual result',
    ...
    es: {
      ...
      scorer_in: 'Sigue en el torneo', scorer_out: 'Eliminado',
      col_player: 'Jugador', col_goals: 'Goles',
      col_wc_total: 'Total Mundiales',
      tip_wc_total: 'Goles históricos en Mundiales (ediciones anteriores + este torneo)',
      group_label: 'Grupo',
      ...
      fix_search_ph: 'Buscar un país…', fix_no_results: 'Sin resultados para esa búsqueda.',
      ...
      scn_title: 'Qué necesita pasar (última fecha)',
      scn_win: 'Gana', scn_draw: 'Empata', scn_lose: 'Pierde',
      scn_qualify: 'Clasifica', scn_inplay: 'En juego', scn_third: 'Opción de mejor 3º', scn_out: 'Fuera', scn_through: 'Ya clasificado',
      ...
      col_chance: '% 16°', tip_chance: 'Probabilidad estimada de llegar a dieciseisavos (simulada según el ranking FIFA). 100% = ya clasificado, 0% = eliminado.',
      ...
      badge_clinched: '🔒 CLASIFICADO', tip_clinched: 'Asegurado entre los 8 mejores terceros: avanza pase lo que pase.',
      ...
      bracket_hint: 'Toca un equipo para elegir quién avanza. Los partidos jugados se completan solos.',
      bracket_reset: 'Reiniciar', champion: 'Campeón', bracket_result: 'resultado real',
